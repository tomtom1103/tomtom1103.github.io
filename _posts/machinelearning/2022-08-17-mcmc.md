...
파이썬으로 구현한 MCMC Metropolis-Hastings 과 Bayesian Estimation 의 예시는 [From Scratch: Bayesian Inference, Markov Chain Monte Carlo and Metropolis Hastings, in python]([MCMC/MCMC.ipynb at master · Joseph94m/MCMC · GitHub](https://github.com/Joseph94m/MCMC/blob/master/MCMC.ipynb)) 를 참고하면 된다.
